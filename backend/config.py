...
CORS_ORIGINS = os.getenv('CORS_ORIGINS', 'http://localhost:3000,http://127.0.0.1:3000,http://localhost:8080,https://your-domain.com,https://tradingbot-4iuxi.ondigitalocean.app').split(',')
